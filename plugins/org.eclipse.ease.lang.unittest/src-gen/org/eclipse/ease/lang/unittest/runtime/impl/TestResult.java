 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.ease.lang.unittest.runtime.impl.TestResult#getStatus <em>Status</em>}</li>
 *   <li>{@link org.eclipse.ease.lang.unittest.runtime.impl.TestResult#getMessage <em>Message</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TestResult extends StackTraceContainer implements ITestResult {
	...
	public void setStatus(TestStatus newStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IRuntimePackage.TEST_RESULT__STATUS, oldStatus, status));
	}
	...
	public void setMessage(String newMessage) {
		...
		message = newMessage;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IRuntimePackage.TEST_RESULT__MESSAGE, oldMessage, message));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IRuntimePackage.TEST_RESULT__STATUS:
				return getStatus();
			case IRuntimePackage.TEST_RESULT__MESSAGE:
				return getMessage();
		}
