...
public class TestSuite extends TestContainer implements ITestSuite {
	/**
	 * The cached value of the '{@link #getActiveTests() <em>Active Tests</em>}' reference list.
	...
	/**
	 * The default value of the '{@link #getMasterEngine() <em>Master Engine</em>}' attribute.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @see #getMasterEngine()
	 * @generated
	 * @ordered
	...
	/**
	 * The cached value of the '{@link #getMasterEngine() <em>Master Engine</em>}' attribute.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @see #getMasterEngine()
	 * @generated
	 * @ordered
	...
	public EList<ITestEntity> getActiveTests() {
		if (activeTests == null) {
			activeTests = new EObjectResolvingEList<ITestEntity>(ITestEntity.class, this, IRuntimePackage.TEST_SUITE__ACTIVE_TESTS);
		}
		return activeTests;
	}
	...
	public void setDefinition(ITestSuiteDefinition newDefinition) {
		ITestSuiteDefinition oldDefinition = definition;
	...
	public void setMasterEngine(IScriptEngine newMasterEngine) {
		IScriptEngine oldMasterEngine = masterEngine;
