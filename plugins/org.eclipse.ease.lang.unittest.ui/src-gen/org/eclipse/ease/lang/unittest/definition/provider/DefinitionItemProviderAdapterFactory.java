...
public class DefinitionItemProviderAdapterFactory extends DefinitionAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable {
	...
	/**
	 * This keeps track of the one adapter used for all {@link org.eclipse.ease.lang.unittest.definition.ITestSuiteDefinition} instances. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	protected TestSuiteDefinitionItemProvider testSuiteDefinitionItemProvider;

	/**
	 * This creates an adapter for a {@link org.eclipse.ease.lang.unittest.definition.ITestSuiteDefinition}. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	@Override
	public Adapter createTestSuiteDefinitionAdapter() {
		if (testSuiteDefinitionItemProvider == null) {
			testSuiteDefinitionItemProvider = new TestSuiteDefinitionItemProvider(this);
		}

		return testSuiteDefinitionItemProvider;
	}

	/**
	 * This keeps track of the one adapter used for all {@link org.eclipse.ease.lang.unittest.definition.IVariable} instances. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @generated
	 */
	...
	/**
	 * This creates an adapter for a {@link org.eclipse.ease.lang.unittest.definition.IVariable}. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	@Override
	 ...
	 * @generated
	 */
	protected FlagToStringMapItemProvider flagToStringMapItemProvider;
	...
	public Adapter createFlagToStringMapAdapter() {
		if (flagToStringMapItemProvider == null) {
			flagToStringMapItemProvider = new FlagToStringMapItemProvider(this);
		}

		return flagToStringMapItemProvider;
	}

	/**
	 * This keeps track of the one adapter used for all {@link org.eclipse.ease.lang.unittest.definition.ICode} instances. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @generated
	 */
	...
	/**
	 * This creates an adapter for a {@link org.eclipse.ease.lang.unittest.definition.ICode}. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	@Override
	...
	public void dispose() {
		if (testSuiteDefinitionItemProvider != null)
			testSuiteDefinitionItemProvider.dispose();
		if (variableItemProvider != null)
			variableItemProvider.dispose();
		if (flagToStringMapItemProvider != null)
			flagToStringMapItemProvider.dispose();
		if (codeItemProvider != null)
