...
public class JavaDoc8LinkCreatorTest {

	private ILinkCreator fLinkCreator;

	@BeforeEach
	public void beforeEach() {
		fLinkCreator = new JavaDoc8LinkCreator(getRemoteDocumentationLocation(), getRemoteSiteContent(), className -> className);
	}
	...
	private List<String> getRemoteSiteContent() {
		return Arrays.asList("java.io", "java.lang");
	}
	...
	public void createLinkForConstructor() throws IOException {
		assertEquals("<a href='" + getRemoteDocumentationLocation() + "/java/lang/String.html#String-byte:A-'>new String(byte[])</a>",
	...
	public void createLinkForMethodWithoutParameter() throws IOException {
		assertEquals("<a href='" + getRemoteDocumentationLocation() + "/java/lang/String.html#getBytes--'>String.getBytes()</a>",
	...
	public void createLinkForMethodWithParameters() throws IOException {
		assertEquals(
				"<a href='" + getRemoteDocumentationLocation() + "/java/lang/String.html#copyValueOf-char:A-int-int-'>String.copyValueOf(char[], int, int)</a>",
	...
	public void createLinkForConstant() throws IOException {
		assertEquals("<a href='" + getRemoteDocumentationLocation() + "/java/io/File.html#pathSeparator'>File.pathSeparator</a>",
	...
	public void createLinkForClass() throws IOException {
		assertEquals("<a href='" + getRemoteDocumentationLocation() + "/java/io/File.html'>File</a>", fLinkCreator.createLink("{@link java.io.File}"));
	}
}
